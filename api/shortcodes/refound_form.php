        ...
        <div class="refound-section-container">
            ...
            if ( !empty($_POST) ) {
                ...
                if ( !empty($_POST['transaction_id']) ) {
                    ...
                    $refound = refound($transaction_id);
                    ...
                    if ( $refound['status'] === 'success' ) { ?>
                        ...
                        <div class='alert error-alert'>
                            ...
                            Revisa que el ID de la transacción sea el correcto o contáctate con <a hreF="mailto:soporte@hiitclub.online">soporte@hiitclub.online</a> para recibir ayuda.</p>
                        </div>
                        ...
                        <div class='alert info-alert'>
                            ...
                            Contáctate con <a hreF="mailto:soporte@hiitclub.online">soporte@hiitclub.online para recibir ayuda.</a></p>
                        </div>
...
add_shortcode('refound_form', 'refound_form'); 